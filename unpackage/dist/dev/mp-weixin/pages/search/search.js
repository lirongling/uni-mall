...
var _search = _interopRequireDefault(__webpack_require__(/*! ./pages/search/search.vue */ 134));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _search_vue_vue_type_template_id_381d05c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search.vue?vue&type=template&id=381d05c6&scoped=true& */ 135);
...
/* harmony import */ var _search_vue_vue_type_style_index_0_id_381d05c6_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search.vue?vue&type=style&index=0&id=381d05c6&scoped=true&lang=scss& */ 139);
...
var components = {
  ...
  "jyf-parser": () =>
    Promise.all(/*! import() | components/jyf-parser/jyf-parser */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/jyf-parser/jyf-parser")]).then(__webpack_require__.bind(null, /*! @/components/jyf-parser/jyf-parser.vue */ 197))
}
var render = function() {
  var _vm = this
...
var _util = _interopRequireDefault(__webpack_require__(/*! ../../static/js/util.js */ 121));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var uniSearchBar = function uniSearchBar() {return __webpack_require__.e(/*! import() | components/uni-search-bar/uni-search-bar */ "components/uni-search-bar/uni-search-bar").then(__webpack_require__.bind(null, /*! @/components/uni-search-bar/uni-search-bar.vue */ 141));};var parser = function parser() {return Promise.all(/*! import() | components/jyf-parser/jyf-parser */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/jyf-parser/jyf-parser")]).then(__webpack_require__.bind(null, /*! @/components/jyf-parser/jyf-parser */ 197));};var _default =
{
  name: "",
  components: {
  ...
  methods: {
        ...
        this.$api.getSearch(val).then(function (res) {
          if (res.status === 200) {
            if (res.data.keywords.length === 0) {
              ...
              _this.searchResult = res.data.keywords;
            }
          }
        }).catch(function (err) {
          console.log(err);
    ...
    // 添加搜索
    addSearch: function addSearch(e) {
      this.initialVal = e;
    },
    // 跳转到详情页
